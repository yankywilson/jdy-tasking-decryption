# JDY Botnet — Tasking Decryption & Infrastructure Analysis

Reverse engineering of the **JDY** botnet's encrypted dispatch tasking, plus a bounded
enumeration of its control infrastructure. JDY is a China-nexus reconnaissance capability
of the **KV-botnet / Volt Typhoon** lineage (MITRE **G1017**), re-detailed by Lumen Black
Lotus Labs in June 2026.

This work recovers the tasking-decryption scheme at the instruction level, provides a
working decryptor, and independently confirms the published control cluster is bounded.
